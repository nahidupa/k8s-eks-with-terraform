...
terraform {
  source = "git::https://github.com/nahidupa/terraform-shared-modules.git//modules/kubernetes_secret?ref=v0.0.4"
}
...
inputs = {
  ...
  metadata_namespace = "istio-system"
  ...
  serect_data = {
    "username" =  local.sensitive_vars.KIALI_USERNAME
    "passphrase" = local.sensitive_vars.KIALI_PASSPHRASE
  }
